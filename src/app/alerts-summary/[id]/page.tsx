                      ...
                      >
                        ...
                        <Box sx={{ pl: 0.5 }}>
                          ...
                          <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                            <Typography variant="body2" fontWeight={500} sx={{ fontSize: '14px', fontFamily: 'Inter, sans-serif' }}>
                              {alert.originCity || alert.city || 'Location not specified'}
                            </Typography>
                          </Box>

                          <Typography variant="body2" sx={{ mb: 2, fontSize: '14px', fontFamily: 'Inter, sans-serif' }}>
                            {alert.description}
                          </Typography>
